...
define('UPLOAD_DIR', IMAGES_DIR . '/upload/images/');
...
#Msg CSS
define('MSG_CSS_SUCCESS', 'alert alert-success');
define('MSG_CSS_FAILED', 'alert alert-danger');
define('MSG_CSS_WARNING', 'alert alert-warning');
define('MSG_CSS_INFO', 'alert alert-info');
...
# Upload
define('UPLOAD_SIZE', 5000000);
define('UPLOAD_FILE_TYPE', 'jpeg jpg png');
define('UPLOAD_SUCCESSFUL_INFO', 'Upload ảnh thành công.');
define('UPLOAD_FAILED_INFO', 'Không thể upload ảnh lên server.');
define('UPLOAD_WRONG_SIZE_TYPE', 'Không thể upload ảnh vì sai kích thước hoặc không đúng loại file.');
